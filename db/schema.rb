...
ActiveRecord::Schema.define(version: 2021_01_21_095257) do
  ...
  create_table "favorites", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["manual_id"], name: "index_favorites_on_manual_id"
    t.index ["user_id", "manual_id"], name: "index_favorites_on_user_id_and_manual_id", unique: true
  ...
  add_foreign_key "favorites", "manuals"
